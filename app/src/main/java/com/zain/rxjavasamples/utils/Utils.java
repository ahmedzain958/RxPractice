package com.zain.rxjavasamples.utils;

import android.util.Log;

import com.androidnetworking.error.ANError;
import com.zain.rxjavasamples.model.ApiUser;
...
public class Utils {
    ...
    public static List<ApiUser> getApiUserList2() {

        List<ApiUser> apiUserList = new ArrayList<>();

        ApiUser apiUserOne = new ApiUser();
        apiUserOne.firstname = "Ahmed";
        apiUserOne.lastname = "Shekhar";
        apiUserList.add(apiUserOne);

        ApiUser apiUserTwo = new ApiUser();
        apiUserTwo.firstname = "Mohamed";
        apiUserTwo.lastname = "Kumar";
        apiUserList.add(apiUserTwo);

        ApiUser apiUserThree = new ApiUser();
        apiUserThree.firstname = "Zain";
        apiUserThree.lastname = "Kumar";
        apiUserList.add(apiUserThree);
